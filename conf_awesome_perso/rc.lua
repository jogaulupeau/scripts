...
globalkeys = awful.util.table.join(
    ...
    -- Modification son
    awful.key({}, "#123", function () awful.util.spawn("amixer -q sset Master 2+", false) end),
    awful.key({}, "#122", function () awful.util.spawn("amixer -q sset Master 2-", false) end),
...
awful.rules.rules = {
    ...
    -- Firefox sur le bureau 1 de l'écran 1
    { rule = { class = "Firefox" },
      properties = { tag = tags[1][1] } },
    -- Chromium sur le bureau 2 de l'écran 1
    { rule = { class = "Chromium" },
      properties = { tag = tags[1][2] } },
}
-- }}}
